                                            ...
                                            <div class="post-content">
                                                <div class="post-cat">
                                                    <div class="post-cat-list">
                                                        <a class="hover-flip-item-wrapper" href="{{ route('portfolioPage',[$portfolio->slug]) }}">
                                                            <span class="hover-flip-item">
                                                                <span data-text="{{ $portfolio->title }}">{{ $portfolio->title }}</span>
                                                            </span>
                                                        </a>
                                                    </div>
                                                </div>
                                                <p class="title">{!! $portfolio->description !!}</p>
                                            </div>
                                        </div>
                                        <div class="post-thumbnail">
                                            <a href="{{ route('portfolioPage',[$portfolio->slug]) }}">
                                                <img src="{{ config('constants.BACKEND').$portfolio->image}}" alt="Post Images">
                                            </a>
                                        </div>
                                    </div>
                                    <!-- End Single Post  -->
